...
avaliable_model_ids_sources = {
    ...
    "zai-org/GLM-4.5": {"source": "huggingface", "config_file": "configs/glm4_moe.py"},
    "zai-org/GLM-4.5-Air": {"source": "huggingface", "config_file": "configs/glm4_moe.py"},
    "zai-org/GLM-4.6": {"source": "huggingface", "config_file": "configs/glm4_moe.py"},
    "zai-org/GLM-4.7": {"source": "huggingface", "config_file": "configs/glm4_moe.py"},
    "zai-org/GLM-5": {"source": "huggingface", "config_file": "configs/glm_moe_dsa.py"},
    "zai-org/GLM-5.1": {"source": "huggingface", "config_file": "configs/glm_moe_dsa.py"},
